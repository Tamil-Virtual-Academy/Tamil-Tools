...
Public Class frmUsingDictionary
    ...
    Dim output As String = pathText & "\DomainIdentificationUsingDictionary"
    Dim fileDateTime As String = DateTime.Now.ToString("ddMMyyyy") & "_" & DateTime.Now.ToString("HHmm")
    Dim outputFile As String = ""
    Dim sbw As New StringBuilder

    Private Sub frmUsingDictionary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim DB_FILE As String = pathText & "\DomainFinalListWithoutDuplicate.txt"

        If System.IO.File.Exists(DB_FILE) = True Then
            Dim objReader As New System.IO.StreamReader(DB_FILE)
            Do While objReader.Peek <> -1
                'Dim lineArray As String() = objReader.ReadLine.Split("|")
                Dim lineArray As String = objReader.ReadLine()
            ...
            For Each pair In dict
                ...
                builder.Append(pair.Key & vbNewLine)

            Next
            rtbDict.Text = builder.ToString
        End If
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If chckList.Items.Count > 0 Then
            ...
            If chkFlag = True Then
                ...
                'System.IO.File.WriteAllText("F:\Pipe.txt", sbw.ToString, Encoding.UTF8)
                ...
                DataGridView1.Columns("DOMAIN NAME").Width = 265
                DataGridView1.Columns("Count").Width = 109
                Grid_Apperance_Con()
    ...
    Private Function searchWords(ByVal TextLine As String) As String
        ...
        End If
        For Each pair In dict
            If pair.Key.Contains("|") Then

                wrd = pair.Key.Split("|"c)
                wr = Trim(wrd(0))
                wr1 = Trim(wrd(1))
                If wr.Contains("(") Then
                    wrd1 = wr.Split("("c)
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        'view.Sort = "Count DESC"
        'DataGridView1.DataSource = view
        'DataGridView1.Columns("DOMAIN NAME").Width = 280
        'DataGridView1.Columns("Count").Width = 100
        'Grid_Apperance_Con()
        'outputFile = output & "\DOMAINS & COUNTS_" & fileDateTime & ".txt"
        'System.IO.File.WriteAllText(outputFile, tot_sb.ToString, Encoding.UTF8)
        'Me.Cursor = Cursors.Default
